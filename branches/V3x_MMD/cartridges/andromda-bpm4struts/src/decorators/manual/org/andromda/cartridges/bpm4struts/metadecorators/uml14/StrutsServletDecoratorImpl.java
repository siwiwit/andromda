 ...
 */
public class StrutsServletDecoratorImpl extends StrutsServletDecorator
{
    // ---------------- constructor -------------------------------

    public StrutsServletDecoratorImpl(org.omg.uml.foundation.core.Classifier metaObject)
    {
        super(metaObject);
    }
    ...
    // abstract in class StrutsServletDecorator ...
    ...
    public java.lang.String getDispatchParameter()
    {
     ...
     *
     */
    public org.omg.uml.foundation.core.ModelElement handleGetUseCase()
    {
