...
public class JavaTypeConverter 
{
    ...
    private static ConversionEntry[] conversionTable = 
    {
        ...
        new ConversionEntry("java.util.Date", "java.lang.String", "new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ssZ\").format({0})"),
        new ConversionEntry("java.sql.Timestamp", "java.lang.String", "new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ssZ\").format({0})"),
        new ConversionEntry("java.sql.Time", "java.lang.String", "new java.text.SimpleDateFormat(\"HH:mm:ssZ\").format({0})"),
        new ConversionEntry("java.sql.Date", "java.lang.String", "new java.text.SimpleDateFormat(\"yyyy-MM-dd\").format({0})"),
        new ConversionEntry("java.lang.String", "java.util.Date", "new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ssZ\").parse({0})"),
        new ConversionEntry("java.lang.String", "java.sql.Timestamp", "new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ssZ\").parse({0})"),
        new ConversionEntry("java.lang.String", "java.sql.Time", "new java.text.SimpleDateFormat(\"HH:mm:ssZ\").parse({0})"),
        new ConversionEntry("java.lang.String", "java.sql.Date", "new java.text.SimpleDateFormat(\"yyyy-MM-dd\").parse({0})"),
        ...
        String targetType)
    {
        ...
        else
        {
            ...
            for (int i = 0; i < conversionTable.length && convertedValue == null; i++)
            {
               ...
               {
                   convertedValue = MessageFormat.format(conversionTable[i].conversionPattern, new Object[] { sourceValue });
               } // if
            } // for
            ...
            if (convertedValue == null && sourceType.startsWith("java.lang."))
            {
                ...
                if (primativeSource.equals("integer"))
                    primativeSource = "int";
                String interimValue = typeConvert(sourceType, sourceValue, primativeSource);
                if (interimValue != null)
                {
                    convertedValue = typeConvert(primativeSource, interimValue, targetType);
                }
            }
            ...
            if (convertedValue == null && targetType.startsWith("java.lang."))
            {
                ...
                if (primativeTarget.equals("integer"))
                    primativeTarget = "int";
                String interimValue = typeConvert(sourceType, sourceValue, primativeTarget);
                if (interimValue != null)
                {
                    convertedValue = typeConvert(primativeTarget, interimValue, targetType);
                }
            }
        }
