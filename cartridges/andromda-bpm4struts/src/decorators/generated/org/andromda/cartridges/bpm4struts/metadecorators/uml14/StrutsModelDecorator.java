 ...
 *
 */
public abstract class StrutsModelDecorator
       ...
       implements org.omg.uml.foundation.core.Classifier
{
    ...
    public StrutsModelDecorator (org.omg.uml.foundation.core.Classifier metaObject)
    {
        super (metaObject);
    ...
    *
    */
    public abstract java.lang.String getFormBeanClassName();
    
   /**
    *
    */
    public abstract java.lang.String getFormBeanName();
