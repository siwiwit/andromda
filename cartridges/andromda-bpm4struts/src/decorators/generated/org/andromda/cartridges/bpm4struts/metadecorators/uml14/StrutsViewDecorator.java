 ...
 *
 */
public abstract class StrutsViewDecorator
       ...
       implements org.omg.uml.foundation.core.Classifier
{
    ...
    public StrutsViewDecorator (org.omg.uml.foundation.core.Classifier metaObject)
    {
        super (metaObject);
    ...
    *
    */
    public abstract java.lang.String getActionStateFullyQualifiedName();
    
   /**
    *
    */
    public abstract java.lang.String getJspFileName();
    
    // ------------- relations ------------------
    
        
    protected abstract java.util.Collection handleGetInputFields();
    ...
    */
    ...
    {
        return decoratedElements(handleGetInputFields());
    }
